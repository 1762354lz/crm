...
%>
<jsp:include page="functionCommon.jsp"/>
<!DOCTYPE html>
<html>
<head>
	<base href="<%=basePath%>">
	...
	<script type="text/javascript">
		...
		$(function(){
            ...
            $("#editActivity").click(function () {
                ...
                getUserListAndActivityOneUpdate();
            })
		...
		function selectDetailActivity() {

            var html="";

            html+='市场活动-${activity.name}<small id="activityDate">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${activity.startDate}~${activity.startDate}</small>';
            $("#activityName").html(html);
            html="";
            html+='<input id="activityId" type="hidden" value="${activity.id}">';
            html+='<div style="position: relative; left: 40px; height: 30px;">';
            html+='<div style="width: 300px; color: gray;">所有者</div>';
            html+='<div style="width: 300px;position: relative; left: 200px; top: -20px;"><b>${activity.owner}</b></div>';
            html+='<div style="width: 300px;position: relative; left: 450px; top: -40px; color: gray;">名称</div>';
            html+='<div style="width: 300px;position: relative; left: 650px; top: -60px;"><b>${activity.name}</b></div>';
            ...
            html+='<div style="width: 300px;position: relative; left: 200px; top: -20px;"><b>${activity.startDate}</b></div>';
            html+='<div style="width: 300px;position: relative; left: 450px; top: -40px; color: gray;">结束日期</div>';
            html+='<div style="width: 300px;position: relative; left: 650px; top: -60px;"><b>${activity.endDate}</b></div>';
            html+='<div style="height: 1px; width: 400px; background: #D5D5D5; position: relative; top: -60px;"></div>';
            html+='		<div style="height: 1px; width: 400px; background: #D5D5D5; position: relative; top: -60px; left: 450px;"></div>';
            html+='		</div>';
            html+='		<div style="position: relative; left: 40px; height: 30px; top: 20px;">';
            html+='		<div style="width: 300px; color: gray;">成本</div>';
            html+='		<div style="width: 300px;position: relative; left: 200px; top: -20px;"><b>${activity.cost}</b></div>';
            ...
            html+='<b>${activity.createBy}&nbsp;&nbsp;</b><small style="font-size: 10px; color: gray;">${activity.createTime}</small></div>';
            ...
            html+='	<div style="width: 500px;position: relative; left: 200px; top: -20px;">';
            html+='<b>${activity.editBy}&nbsp;&nbsp;</b><small style="font-size: 10px; color: gray;">${activity.editTime}</small></div>';
            html+='<div style="height: 1px; width: 550px; background: #D5D5D5; position: relative; top: -20px;"></div>';
            html+='		</div>';
     ...
     function saveRemark() {
         $.ajax(
             {
                 url: "workbench/remark/saveRemark.do",
...
<body>
                ...
                <div class="modal-body">
                    ...
                    <form class="form-horizontal" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10" style="width: 300px;">
                                <input type="text" readonly class="form-control" id="edit-name" value="${activity.name}">
                            </div>
                        </div>
	...
	<div style="position: relative; left: 40px; top: -30px;">
		<div class="page-header">
			<h3 id="activityName"> <small id="activityDate"></small></h3>
		</div>
		<div style="position: relative; height: 50px; width: 250px;  top: -72px; left: 700px;">
            <button id="editActivity" type="button" class="btn btn-default"><span class="glyphicon glyphicon-edit"></span> 编辑</button>
	...
	<div style="position: relative; top: -70px;" id="detailActivity">
