...
<script type="text/javascript">
	...
	$(function(){$("#edit").click(function () {
		...
		html+=+"${activity.startDate}"+"~"+"${activity.endDate}";
		alert(html);
			$("#activityDate").html(html);
			html="";
	html+="市场活动-"+"${activity.name}";
	...
	html+='<div style="position: relative; left: 40px; height: 30px;">';
		...
		html+='		<div style="width: 500px;position: relative; left: 200px; top: -20px;"><b>'+"${activity.createBy}"+'&nbsp;&nbsp;</b><small style="font-size: 10px; color: gray;">2017-01-18 10:10:10</small></div>';
		...
		html+='	<div style="width: 500px;position: relative; left: 200px; top: -20px;"><b>'+"${activity.editBy}"+'&nbsp;&nbsp;</b><small style="font-size: 10px; color: gray;">2017-01-19 10:10:10</small></div>';
		html+='<div style="height: 1px; width: 550px; background: #D5D5D5; position: relative; top: -20px;"></div>';
		html+='		</div>';
