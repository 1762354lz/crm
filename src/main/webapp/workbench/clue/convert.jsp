...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#activityPageList").click(function () {
...
<body>
	...
	<div id="title" class="page-header" style="position: relative; left: 20px;">
		<h4>转换线索 <small>${clue.appellation}-${clue.company}</small></h4>
	</div>
	<div id="create-customer" style="position: relative; left: 40px; height: 35px;">
		新建客户：${clue.company}
	</div>
	<div id="create-contact" style="position: relative; left: 40px; height: 35px;">
		新建联系人：${clue.appellation}
	</div>
	...
	<div id="create-transaction2" style="position: relative; left: 40px; top: 20px; width: 80%; background-color: #F7F7F7; display: none;" >
		...
		<form id="tranForm" action="workbench/clue/convert.do" method="post">
			<input type="hidden" value="${clue.id}" name="clueId">
		  ...
		  <div class="form-group" style="width: 400px;position: relative; left: 20px;">
		    <label for="activity">市场活动源&nbsp;&nbsp;<a id="activityPageList" href="javascript:void(0);"  style="text-decoration: none;"><span class="glyphicon glyphicon-search"></span></a></label>
		    <input type="text" class="form-control" id="activity" placeholder="点击上面搜索" readonly >
			  <input type="hidden" id="activityId" name="source" >
		  </div>
		</form>
	...
	<div id="operation" style="position: relative; left: 40px; height: 35px; top: 100px;">
		...
		&nbsp;&nbsp;&nbsp;&nbsp;
		<input onclick="window.location.href='workbench/clue/index.jsp'" class="btn btn-default" type="button" value="取消">
	</div>
</body>
</html>